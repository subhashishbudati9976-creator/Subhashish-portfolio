/**
 * ProjectCard — Reusable project presentation component
 *
 * Renders one project entry with title, summary, contributions,
 * tech stack, and links. Links with href=null are rendered as
 * visually disabled to avoid fabricating unverified URLs.
 */
      ...
      <div className="project-links">
        ...
        {github.href ? (
          <a
            ...
            aria-label={`${github.label} for ${title} (opens in new tab)`}
          >
            <GitHubIcon />
            {github.label}
          </a>
          ...
          <span
            className="project-link-btn"
            aria-disabled="true"
            aria-label={`${github.label} — URL not yet verified`}
            title="GitHub URL not yet configured"
          >
            <GitHubIcon />
            {github.label}
          </span>
        ...
        {live.href ? (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={`${live.label} for ${title} (opens in new tab)`}
          >
            <ExternalIcon />
            {live.label}
          </a>
          ...
          live.label && (
            <span
              className="project-link-btn"
              aria-disabled="true"
              aria-label={`${live.label} — URL not yet verified`}
              title="Live URL not yet configured"
            >
              <ExternalIcon />
              {live.label}
            </span>
...
/* Inline SVG icons — kept small, no external icon dependency */
